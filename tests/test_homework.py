...
class TestPost:
    def test_post_model(self):
        ...
        ), "Add a user, the author who created the event `Author` Model` Post`"
        assert (
    ...
    def test_post_admin(self):
        ...
        assert (
            admin_model.empty_value_display == "-empty-"
        ), "Add the default value `-empty-` for an empty field "
...
class TestGroup:
    def test_group_model(self):
        ...
        ), "Add a description of `description` Model` Group` "
        assert (
