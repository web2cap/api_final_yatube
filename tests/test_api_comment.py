...
class TestCommentAPI:
    ...
    def test_comments_create(self, user_api_client, post, user, another_user):
        ...
        assert (
            comments_count + 1 == Comment.objects.count()
    ...
    @pytest.mark.django_db(transaction=True)
    def test_comment_patch_current(
        self, user_api_client, post, comment_1_post, comment_2_post
    ):
        ...
        assert (
            test_comment.text == "Changed the text of the comment"
    ...
    @pytest.mark.django_db(transaction=True)
    def test_comment_delete_current(
        self, user_api_client, post, comment_1_post, comment_2_post
    ):
